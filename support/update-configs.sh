...
PROJECTS="designate glance heat keystone mistral nova neutron cinder ironic swift manila"
...
for PROJECT in $PROJECTS; do
  ...
  for RELEASE in $RELEASES; do
    ...
    if [ -f $EXCEPTIONDIR/${PROJECT}-${RELEASE}.genconfig ]; then
      . $EXCEPTIONDIR/${PROJECT}-${RELEASE}.genconfig
    elif [ -f $EXCEPTIONDIR/${PROJECT}.genconfig ]; then
      . $EXCEPTIONDIR/${PROJECT}.genconfig
    else
